...
class ProficientUser extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return ProficientUserState();
  }
}

class ProficientUserState extends State<ProficientUser> {
  @override
  void initState() {
    Data cartProvider = Provider.of<Data>(context, listen: false);
    //ategoryApi.getCategoriesKolay(cartProvider);
    super.initState();
  }
  /*void initState() {
